      ...
      <nav class="col-12@lg order-1@lg">
        <ul class="grid gap-lg">
          <li class="col-6@xs col-3@md">
            <h4 class="margin-bottom-sm text-base@md">Title Bloc</h4>
            <ul class="grid gap-xs text-sm@md">
              <li><a href="#0" class="main-footer__link">Link One</a></li>
              <li><a href="#0" class="main-footer__link">Link Two</a></li>
              <li><a href="#0" class="main-footer__link">Link Three</a></li>
              <li><a href="#0" class="main-footer__link">Link Four</a></li>
            </ul>
          </li>
...
<script src="/codyhouse-framework/main/assets/js/util.js"></script>
<script src="/codyhouse-framework/main/assets/js/scripts.js"></script>
<script src="/codyhouse-framework/main/assets/js/navbar.js"></script>
<script src="/codyhouse-framework/main/assets/js/tab.js"></script>
<script src="/codyhouse-framework/main/assets/js/calendar.js"></script>
</body>
</html>